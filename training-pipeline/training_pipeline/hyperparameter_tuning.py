...
from training_pipeline.config import gridsearch as gridsearch_config
from training_pipeline.data import load_data_from_feature_store
from training_pipeline.model import build_model
...
def run_hyperparameter_optimization(
    ...
    sweep_id = wandb.sweep(
        sweep=gridsearch_config.sweep_configs, project="mlep_forecasting_new_version"
    )
    wandb.agent(
        project="mlep_forecasting_new_version",
        sweep_id=sweep_id,

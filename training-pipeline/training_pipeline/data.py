...
def load_data_from_feature_store(
    ...
    with init_wandb_run(
        ...
        feature_view = fs.get_feature_view(
            name="energy_consumption_new_denmark", version=feature_view_version
        )
        ...
        raw_data_at = wandb.Artifact(
            name="energy_consumption_denmark_feature_view_2",
            type="feature_view",
    ...
    with init_wandb_run(
        ...
        run.use_artifact("energy_consumption_denmark_feature_view_2:latest")

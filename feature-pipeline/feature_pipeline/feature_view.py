...
def create(
    ...
    project = hopsworks.login(
        api_key_value=settings.SETTINGS["FS_API_KEY"], project="energy_consumption_mlep"
    )
    ...
    try:
        name_feature_views = "energy_consumption_new_denmark"
    ...
    energy_consumption_fg = fs.get_feature_group(
        name="energy_consumption_new_version",
        version=feature_group_version
    )
    ds_query = energy_consumption_fg.select_all()
    feature_view = fs.create_feature_view(
        name="energy_consumption_new_denmark",
